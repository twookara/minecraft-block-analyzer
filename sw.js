const CACHE='mcba-v159';
const CORE=['./manifest.webmanifest','./icon-192.png','./icon-512.png','./index.html','./results.html'];
...
self.addEventListener('fetch',e=>{
 ...
 const fresh=e.request.mode==='navigate'||u.pathname.endsWith('/')||u.pathname.endsWith('/index.html')||u.pathname.endsWith('/results.html')||u.pathname.endsWith('/sw.js');
